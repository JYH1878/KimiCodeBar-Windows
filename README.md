...
- **总览页**：面板第一页「总览」一屏看全所有账号——Kimi / GLM 账号各显示 5 小时 / 7 天两条迷你进度条（已用百分比 + 剩余量 + 重置倒计时），DeepSeek 账号显示总余额与币种；低额度账号整行标红；点击任意一行直接跳到该账号详情页，滚轮 / 拖拽 / 圆点翻页照旧。极简模式下自动精简为一行一个账号的关键数字
