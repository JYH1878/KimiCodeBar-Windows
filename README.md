...
1. 到 [Releases](https://github.com/JYH1878/KimiCodeBar-Windows/releases) 下载最新的 `KimiCodeBar_x.x.x_x64-setup.exe`
2. 双击安装——当前用户安装，**无需管理员权限**，装完出现在开始菜单
3. 首次启动后图标常驻系统托盘（可能在"隐藏的图标"折叠区，拖出来即可）
